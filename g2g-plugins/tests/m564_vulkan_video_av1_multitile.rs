...
//! software (dav1d) decoder is checked when `G2G_VULKAN_REF_DIR` names a directory of `tools/vulkan-refs.sh` dumps: all 11 frames SAD/px 0.
//!
...
const CLIP_FIXTURE: &str = "av1_640x480_tiles2x2.obu";
const W: usize = 640;
const H: usize = 480;
